  ...
  return (
    <section id="about" className="about-section">
      <div className="about-text">
        ...
        <p>
          I enjoy crafting intuitive and visually appealing interfaces with a
          user-centered focus. My experience includes
          <strong> wireframing, prototyping, responsive design, and design principles</strong>
          that deliver smooth experiences across devices.
        </p>
        <p>
